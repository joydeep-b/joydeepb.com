...
Director, Center for Human and Robot Co-Adaptation ({\small\itshape
NSF Science and Technology Center, est.\ 2026})\\
Associate Director, Texas Robotics,
The University of Texas at Austin\\
\vspace{-0.5em}\\
...
\begin{longtable}{@{}p{1.2cm} >{\raggedright\arraybackslash}p{\dimexpr\textwidth-1.2cm-2\tabcolsep\relax}@{}}
  2026  & Chief of Naval Research Fellow, Office of Naval Research, inaugural class; one of 12 selected from more than 180 nominations \\
  2026  & AAAI Senior Member, Class of 2026 \\
  2026  & IEEE Senior Member \\
  2026  & Best Paper Award Finalist in Field and Service Robotics, ICRA 2026, \emph{GuideTWSI} \\
  2026  & Best Paper Honourable Mention, HRI 2026, \emph{GuideNav} \\
  2025  & Third Place, RoboCup 2025 Humanoid League (Adult Size), \emph{UT Austin Villa}\\
  2025  & Best Paper Runner-up, RSS 2025 Workshop on Resilient Off-road Autonomous Robotics, \emph{OVerSeeC} \\
  2025  & Best Paper Award, ICRA 2025 Workshop on Advances in Social Navigation, \emph{HEIGHT} \\
  2024  & Best Paper Award, ACM CHI Conference on Human Factors in Computing Systems, \\
        & \emph{Informed Guide Dog Robot Design}  \\
  2024  & JP Morgan Faculty Research Award \\
  2023  & Best Paper Award Nominee, AAAI Spring Symposium on HRI in Academia and Industry: Bridging the Gap, \emph{Benchmarking Social Robot Navigation Across Academia and Industry} \\
  ...
  2018  & Best Interactive Demo Award, AAMAS 2018, \emph{Interactive Robot Transition Repair With SMT: Demonstration} \\
...
\begin{longtable}{@{}p{2.3cm} >{\raggedright\arraybackslash}p{3.4cm} >{\raggedright\arraybackslash}p{\dimexpr\textwidth-5.7cm-4\tabcolsep\relax}@{}}
  2024 - Present & Visiting Professor & NVIDIA \\
  2023 - Present & Associate Professor & Computer Science Department,
  University of Texas at Austin, TX, USA \\
  2019 - 2025 & Adjunct Assistant Professor &  College of Information and Computer Sciences, University of Massachusetts Amherst, MA, USA\\
...
\textbf{NSF Science and Technology Center ``\emph{Center for Human and Robot Co-Adaptation}''}\\
Role: PI and Center Director.\\
Award: 2535195.\\
Period: September 2026 -- August 2031.\\
Five-year, \$30M NSF Science and Technology Center.\\
Six-university collaboration: UT Austin (lead), MIT, Yale University,
Indiana University Bloomington, University of Utah, and Tufts University.
\par\vspace{2\baselineskip}

\textbf{NIH Award ``\emph{Human-Centered Development of Guide-dog Robots
}''}\\
Role: Co-PI.\\
PI: Donghyun Kim (UMass Amherst).\\
Co-PIs: Ivan Lee (UMass Amherst), Nicholas Giudice (University of Maine).\\
Period: October 2025 -- September 2028.\\
\funding{Amount: \$1,000,000}

\textbf{NSF Award ``\emph{Collaborative Research: SLES: No Bad Surprises: Aligning Agent and Human Norms via Specification Refinements}''}\\
Role: Co-PI.\\
PI: Sandhya Saisubramanian (Oregon State University).\\
Co-PIs: Houssam Abbas (Oregon State University), Shlomo Zilberstein (UMass Amherst).\\
Period: October 2024 -- September 2028.\\
\funding{Amount: \$375,000}

\textbf{Army Research Laboratories Award ``\emph{SARA Sprint 3: Long-Range Offroad Introspective Driving}''}\\
Role: PI.\\
Period: January 2024 -- December 2025.\\
\funding{Amount: \$1,398,473}

\textbf{NSF Award ``\emph{FMitF: Track I: Program Synthesis for Robot
...
\textbf{Amazon Faculty Research Award, 2024}\\
Role: PI.\\
Collaborators: Roberto Martin-Martin\\
...
{\bf Instructor, CS 304I, Fall 2025, Fall 2026: The Essentials of AI for Life and Society}\\
University-wide course, University of Texas at Austin

{\bf Instructor, CS 393R, Fall 2020, Fall 2021, Spring 2024: Autonomous Robots}\\
...
{\em Next G Alliance Technology Roadmap Working Group, virtual, August 12, 2026}

Habits, Goals, and Surprises: Learning and Reasoning for Open-World Navigation\\
{\em Keynote talk, RSS Workshop on Open World Navigation in the Foundation Model Era: Robustness and Failure Recovery, Sydney, Australia, July 17, 2026}

Robots Without Boundaries: Embracing the Unseen and Tackling Novel Tasks\\
{\em Machine Learning, Responsible AI, and Robotics Symposium, UT Austin, March 3, 2026}

Reading the Dirt: Learning What Matters (and What Doesn't) for Off-Road
Navigation\\
{\em Keynote talk, RSS 2025 Workshop on Resilient Off-road Autonomous Robotics, June 2025}

Robots Without Boundaries: Embracing the Unseen and Tackling Novel Tasks\\
{\em Amazon Consumer Robotics Symposium}, May 2025

Robots Without Boundaries: Embracing the Unseen and Tackling Novel Tasks\\
{\em Keynote talk,  Texas Regional Robotics Symposium}, May 2025

Teaching Robots To ``Get It Right''\\
{\em Invited talk, Oregon State University}, January 2025

Teaching Robots To ``Get It Right''\\
{\em Keynote talk, The 37th  International FLAIRS Conference}, May 2024
...
Panel Member, 2025 AAAI Presidential Panel on the Future of AI:
\url{https://aaai.org/about-aaai/presidential-panel-on-the-future-of-ai-research/} 
...
Presented an introduction to ``Christine'' within the scientific context of
...
to a general public audience. \emph{``Where am I?'' and
  Other Fundamental Questions Robots Think Long and Hard to Answer}
...
\subsection*{Significant Service Roles}

\begin{itemize}
  \item Executive Councilor, Association for the Advancement of Artificial Intelligence (AAAI): current term through 2027
  \item Student Chair, Association for the Advancement of Artificial Intelligence (AAAI): current
  \item Co-Editor-in-Chief, Elsevier Robotics and Autonomous Systems: July 2026 -- present
  \item Local Chair, Conference on Robot Learning (CoRL): 2026
  \item Associate Program Chair, AAAI Conference on Artificial Intelligence (AAAI): 2026, 2027
  \item Senior Member Track Co-Chair, AAAI Conference on Artificial Intelligence (AAAI): 2025
  ...
  \item Associate Editor, Elsevier Robotics and Autonomous Systems: 2019 -- June 2026
...
\begin{itemize}
 \item Rohan Chandra, 2022 -- 2024, currently Assistant Professor at the University of Virginia
 \item Kiarash (Kia) Rahmani, 2022 -- 2024, currently Applied AI Scientist at Durable AI
 \item Nathan Tsoi, 2025 -- present
\end{itemize}

\subsection*{PhD Supervisor}
\begin{itemize}
  \item Taijing Chen, UT Austin. 2024--present
  ...
  \item Eric Hsiung, UT Austin. 2022--present
  \item Emily Pruc, UMass Amherst. 2018--2022
  \item Amanda Adkins, UT Austin. 2020--2026, currently at Amazon \\
