...
\begin{tabular}{ p{1.2cm} l }
  ...
  2025  & Third Place, RoboCup 2025 Humanoid League (Adult Size),
      \emph{UT Austin Villa}\\
...
\begin{tabular}{ p{2cm} l p{8cm}}
  2026 & Local Chair, Conference on Robot Learning (CoRL)\\
  2026 & Associate Program Chair, AAAI Conference on Artificial Intelligence (AAAI)\\
  2025 & Senior Member Track Co-Chair, AAAI Conference on Artificial Intelligence (AAAI)\\
  ...
  2022, 2023 & Diversity and Inclusion Co-Chair, AAAI Conference on Artificial
  Intelligence (AAAI)\\
